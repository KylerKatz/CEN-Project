...
class StudentDashboard extends React.Component {
	...
	async componentDidMount() {
		axios
			.get('https://cen-group-2.herokuapp.com/api/Quiz')
			.then((response) => {
				this.setState({
	...
	async updatePoints(score) {
		...
		await axios
			.put('https://cen-group-2.herokuapp.com/api/Signup/Points', newInfo)
			.then((response) => {
	...
	async clearClusters() {
			...
			await axios.put('https://cen-group-2.herokuapp.com/api/Signup/Clear', emmm).then((res) => { 
				console.log('cleared');
